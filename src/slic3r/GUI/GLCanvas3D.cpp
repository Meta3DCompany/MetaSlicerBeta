...
wxDEFINE_EVENT(EVT_GLCANVAS_COLLAPSE_CHATFRAME, SimpleEvent);
        ...
        for (int i = 0; i< m_volumes.volumes.size()/div; i++) {
            ...
            if (0 <= object_idx && object_idx < (int)m_model->objects.size()) {
                ...
                if(if_idex)
                {
                    ...
                    std::cout<<"Printable is set"<<std::endl;
                }
                ...
                if (model_object != nullptr ) {
                    ...
                    {
                        std::cout<<"MIRRORCOPY hareket"<<std::endl;
                        ...
                        if(strategy== LoadStrategy::IdexMirror){
                            ...
                            std::cout<<"MIRROR hareket"<<std::endl;
                        }
                            ...
                            idex_object->instances[instance_idx]->set_mirror({ 1.0, 1.0, 1.0 });
                            std::cout<<"COPY hareket"<<std::endl;
                        }
                    }
