...
PingCodeBindDialog::~PingCodeBindDialog() {
     ...
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log in printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
     ...
     m_link_Terms_title->SetForegroundColour(wxColour(0xFFAE00 ));
     ...
     m_link_privacy_title->SetForegroundColour(wxColour(0xFFAE00 ));
     ...
     m_link_notice_title->SetForegroundColour(wxColour(0xFFAE00 ));
...
std::string icon_path = (boost::format("%1%/images/logo_360.ico") % resources_dir()).str();
     ...
     m_button_unbind->SetBorderColor(wxColour(255,174,0));
