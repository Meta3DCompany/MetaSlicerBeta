...
*/
    ...
    case GUI_App::EAppMode::Editor:
        ...
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("logo_360.ico"), wxBITMAP_TYPE_ICO), "OrcaSlicer");
        break;
...
wxBoxSizer* MainFrame::create_side_tools()
{
                         ...
                         //Meta3D: Slice options front end
...
#else
    SetIcon(wxIcon(var("logo_360.png"), wxBITMAP_TYPE_PNG));
#endif // _WIN32
