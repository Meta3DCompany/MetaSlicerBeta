...
#define SELECT_ALL_OPTION_COLOUR wxColour("#FFAE00 ")
...
static const std::vector<std::string> printer_vendors = 
    {"Meta3D", "Anker",              "Anycubic",           "Artillery",          "Bambulab",           "BIQU",
...
static const std::unordered_map<std::string, std::vector<std::string>> printer_model_map =
    {
     {"Meta3D",         {"XPro", "IXPro", "XPro - MIRROR", "XPro - COPY"}},
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(255,174,0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255,174,0), StateColor::Hovered),
