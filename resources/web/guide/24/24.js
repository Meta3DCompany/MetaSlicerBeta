...
'</div>';
		...
		if(OneModel['model']=="Meta3D XPro - MIRROR" || OneModel['model']=="Meta3D XPro - COPY")
		{
			//Meta3D: Do nothing
		}
		else{
...
function CheckBoxOnclick(obj) {
	...
	if(strModel === "Meta3D XPro")  //Meta3D: Shitty fix for adding the idex printers
	{
		SetModelSelect("Meta3D", "Meta3D XPro - MIRROR", strNozzel, obj.checked);
		SetModelSelect("Meta3D", "Meta3D XPro - COPY", strNozzel, obj.checked);
		//window.alert("fsdf");
	}
